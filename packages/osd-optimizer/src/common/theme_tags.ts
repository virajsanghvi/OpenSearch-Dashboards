...
export type ThemeTag = 'v7light' | 'v7dark' | 'v8light' | 'v8dark' | 'trineolight' | 'trineodark';
export const DEFAULT_THEMES = tags('v7light', 'v7dark', 'v8light', 'v8dark', 'trineolight', 'trineodark');
export const ALL_THEMES = tags('v7light', 'v7dark', 'v8light', 'v8dark', 'trineolight', 'trineodark');
